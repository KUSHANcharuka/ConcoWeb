...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Identifies all elements directly from the Revit model and generates a standard BOQ automatically. AI predicts rates for each line item — existing tools stop at measurement.",
