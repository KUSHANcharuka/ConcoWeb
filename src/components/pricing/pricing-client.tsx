...
const PRODUCTS: Product[] = [
  {
    ...
    category: "estimation",
    icon: Scale,
    description: "Enter plot details to get allowable uses, maximum heights, floor area ratios, and local sanitary requirements instantly.",
    priceType: "one-off",
    basePrice: 4500,
    ...
    demoLink: "https://drive.google.com/drive/folders/1WbhlgnVj0X2F73J6R_TlOxBr1JHJmkDI?usp=sharing"
  },
  {
    id: "hand_drawn_cad",
    ...
    category: "design",
    icon: FileText,
    description: "Converts photographed hand-drawn architectural plans into clean, editable AutoCAD files.",
    priceType: "one-off",
    basePrice: 4000,
    ...
    demoLink: "https://drive.google.com/file/d/11wUzRrAVFkZ9ODdBVGoduafccBcFRRqP/view?usp=sharing"
  },
  {
    id: "conversion_2d_3d",
    ...
    category: "design",
    icon: Layers,
    description: "Reads flat 2D blueprint drawings and converts slab/geometry elements automatically into a 3D BIM model.",
    priceType: "one-off",
    basePrice: 2200,
    ...
    demoLink: "https://drive.google.com/drive/folders/1H63HxhRAEjOyEDD424G4Yh1BNrKz-6U9?usp=sharing"
  },
  {
    id: "word_to_bim",
    name: "WordtoBIM",
    category: "design",
    icon: Bot,
    description: "Generates compliant 3D models and schedules directly from plain text natural language commands.",
    priceType: "per-seat",
    basePrice: 10,
    ...
    demoLink: "https://drive.google.com/drive/folders/1C8KTwemod1FyxAuZr7jefJLqbs1LCn2L?usp=sharing"
  },
  {
    id: "cost_calculator",
    ...
    category: "estimation",
    icon: DollarSign,
    description: "Analyzes concept sketches to compute Gross Floor Area (GFA) and generate immediate cost plans.",
    priceType: "one-off",
    basePrice: 3500,
    maintenancePrice: 300,
    ...
    demoLink: "https://drive.google.com/file/d/1hCtxWtFzPzOcWqu7VBon84aMdadLac35/view?usp=sharing"
  },
  {
    id: "erp_automation",
    ...
    category: "operations",
    icon: Zap,
    description: "Translates emails and mobile field entries directly into back-office ERP records and work cards.",
    priceType: "one-off",
    ...
    demoLink: "https://drive.google.com/drive/folders/18J2VjOiLVjqKuZjIgUzGHVGSg2eFR1hd?usp=sharing"
  },
  {
    id: "tender_eval",
    ...
    category: "estimation",
    icon: Filter,
    description: "Retrieves bid pricing files from subcontractor emails and tabulates comparisons automatically.",
    priceType: "one-off",
    basePrice: 1500,
    ...
    demoLink: "https://drive.google.com/file/d/1D9wgpsdrfEMBNuGDxDVoDXgRtpkwTegW/view?usp=sharing"
  },
  {
    id: "auto_rebar",
    ...
    category: "estimation",
    icon: Wrench,
    description: "Scans structural blueprints using computer vision to build rebar measurement schedules.",
    ...
    demoLink: "https://drive.google.com/file/d/1XBMGXEbDW-rCS--nutSVrk7YtacQY0KW/view?usp=sharing"
  },
  {
    id: "drawing_boq",
    ...
    category: "estimation",
    icon: FileText,
    description: "Identifies structural elements on flat plans to compute a fully priced Bill of Quantities.",
    priceType: "one-off",
    basePrice: 1800,
  ...
  },
  {
    ...
    category: "operations",
    icon: Users,
    description: "Field application for project site managers to record logs, sync photos, and auto-submit Daily Progress Reports (DPR).",
    priceType: "per-seat",
    ...
    demoLink: "https://drive.google.com/file/d/1bof_YpZZdzkxGAQEfGqYNdAASqSkiZ0p/view?usp=sharing"
  },
  {
    id: "measure_on_air",
    ...
    category: "operations",
    icon: Layers,
    description: "Allows surveyors to register dimensions directly on site drawings, auto-calculating payment claims.",
    priceType: "flat-monthly",
    basePrice: 200,
  ...
  },
  {
    ...
    category: "operations",
    icon: Wrench,
    description: "Searchable constructor supplier marketplace and pricing benchmarks portal license.",
    priceType: "flat-monthly",
    basePrice: 14,
    ...
    demoLink: "https://drive.google.com/file/d/1SZPURCcouuLthXbbxqzcg7uSmoWpw2fQ/view?usp=sharing"
  },
  {
    id: "builder_bot",
    ...
    category: "legal",
    icon: Scale,
    description: "FIDIC contract and drawing intelligence chatbot trained to parse project records and legal clauses.",
    priceType: "per-seat",
    ...
    demoLink: "https://drive.google.com/drive/folders/1LjhYwDP6qtu6pAY0qc6H226xLNhB7z-L?usp=sharing",
...
export function PricingClient() {
  const [activeTab, setActiveTab] = useState<"all" | "design" | "estimation" | "operations" | "legal">("all")
  ...
  const totalImmediateDue = pricingSubtotals.oneOffTotal + pricingSubtotals.monthlyRecurring
    ...
    <div className="relative min-h-screen bg-background pt-32 pb-24 pricing-page-root">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            Select the specific Concolabs tools you need. Drag the seat slider to adjust subscription tools, and unlock compound discounts on bundles.
          </motion.p>
        </div>
        ...
        >
          <div className="flex flex-wrap justify-between items-center gap-6 w-full">
            ...
            <div className="flex items-center gap-3">
              <span className={`text-sm font-medium transition-colors ${billingCycle === "monthly" ? "text-foreground font-semibold" : "text-muted-foreground"}`}>
                Monthly billing
              </span>
              <button
              ...
              <span className={`text-sm font-medium transition-colors flex items-center gap-1.5 ${billingCycle === "annual" ? "text-foreground font-semibold" : "text-muted-foreground"}`}>
                Annual billing
            ...
            <div className="flex items-center gap-4 bg-zinc-100/50 dark:bg-zinc-900/30 border border-border px-5 py-2.5 rounded-2xl flex-1 max-w-sm w-full">
              <div className="flex flex-col gap-0.5 flex-1">
                <div className="flex justify-between text-xs text-muted-foreground font-medium">
                  ...
                  <span className="text-foreground font-bold">{seats} users</span>
                </div>
                <input
                  type="range"
                  min="1"
          ...
          <div className="flex flex-wrap gap-2 justify-center border-t border-border/40 pt-4 w-full">
            {(["all", "design", "estimation", "operations", "legal"] as const).map((tab) => (
              <button
                key={tab}
              ...
              >
                {tab === "all" ? "All Tools" : tab === "design" ? "Design AI" : tab === "estimation" ? "Estimation & BOQ" : tab === "operations" ? "Site Ops" : "Legal"}
              </button>
            ))}
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-24">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <h3 className="text-lg font-bold text-foreground mb-1 tracking-tight leading-snug">{prod.name}</h3>
                        <span className="text-[10px] text-muted-foreground font-semibold block mb-3.5">{prod.pill}</span>
                        ...
                        <ul className="space-y-2 mb-6">
                          {prod.features.map((feat, fIdx) => (
                            <li key={fIdx} className="flex items-start gap-2 text-xs text-foreground/90 font-medium leading-normal">
                      ...
                      <div className="border-t border-border/40 pt-4 flex justify-between items-center mt-auto">
                        <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider">License Model</span>
                        <div className="text-right">
                          {prod.priceType === "one-off" ? (
                            <div className="flex flex-col items-end">
                              <span className="font-extrabold text-foreground text-base">${prod.basePrice.toLocaleString()} one-off</span>
                              {prod.maintenancePrice && (
                                <span className="text-[9px] text-muted-foreground">+${prod.maintenancePrice}/yr maintenance</span>
                              )}
                            </div>
                          ) : prod.priceType === "flat-monthly" ? (
                            <span className="font-extrabold text-foreground text-base">${prod.basePrice}/mo flat</span>
                          ) : prod.priceType === "per-seat" ? (
                            <div className="flex flex-col items-end">
                              <span className="font-extrabold text-foreground text-base">${prod.basePrice}/user/mo</span>
                              {prod.basePrice === 8 && (
                                <span className="text-[9px] text-muted-foreground">Billed annually ($100/yr)</span>
                              )}
                            </div>
                          ) : (
                            <span className="font-bold text-muted-foreground text-xs uppercase tracking-wide">Custom / R&D</span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="flex gap-2.5 mt-4 pt-3 border-t border-border/30">
                        <Button variant="outline" size="sm" asChild className="flex-1 py-3 text-[10px] h-auto font-bold rounded-lg cursor-pointer pricing-btn-outline">
                          <a href={prod.demoLink} target="_blank" rel="noopener noreferrer">
                            Watch Demo
                          </a>
                        </Button>
                        
                        {prod.externalLink ? (
                          <Button size="sm" asChild className="flex-1 py-3 text-[10px] h-auto font-bold rounded-lg cursor-pointer bg-foreground text-background pricing-btn-primary">
                            <a href={prod.externalLink} target="_blank" rel="noopener noreferrer">
                              Visit Website
                            </a>
                          </Button>
                        ) : (
          ...
          <div className="lg:col-span-1">
            <div className="bg-card border border-foreground p-6 rounded-3xl shadow-lg sticky top-28">
              <h3 className="text-2xl font-bold text-foreground mb-4">Pricing Breakdown</h3>
              ...
              {pricingSubtotals.activeList.length > 0 ? (
                <div className="space-y-4 mb-6">
                  ...
                  <div className="border-b border-border/60 pb-3 max-h-[160px] overflow-y-auto pr-1">
                    <h4 className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Selected Tools ({pricingSubtotals.activeList.length})</h4>
                    <ul className="space-y-1.5">
                      {pricingSubtotals.activeList.map((p) => (
                        <li key={p.id} className="flex justify-between items-center text-xs font-semibold text-foreground/90 leading-tight">
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    {/* Seats indicator */}
                    {selectedProducts.some(id => PRODUCTS.find(p => p.id === id)?.priceType === "per-seat") && (
                    ...
                    {seatDiscountPercent > 0 && selectedProducts.some(id => PRODUCTS.find(p => p.id === id)?.priceType === "per-seat") && (
                      <div className="flex justify-between text-lime-dark dark:text-lime font-bold">
                        <span>Workspace Seat Discount (-{seatDiscountPercent}%)</span>
                    ...
                    {bundleDiscountPercent > 0 && (
                      <div className="flex justify-between text-lime-dark dark:text-lime font-bold">
                        <span>Stacked Bundle Discount (-{bundleDiscountPercent}%)</span>
                    ...
                    <div className="space-y-1.5 border-t border-border/40 pt-3.5">
                      {pricingSubtotals.oneOffTotal > 0 && (
                        <div className="flex justify-between text-muted-foreground font-semibold">
                          ...
                          <span className="text-foreground">${pricingSubtotals.oneOffTotal.toLocaleString()}</span>
                        </div>
                      )}
                      
                      {pricingSubtotals.oneOffTotal > 0 && pricingSubtotals.annualMaintenance > 0 && (
                        <div className="flex justify-between text-muted-foreground text-[10px]">
                          <span>Annual Maintenance Fee</span>
                          <span>+${pricingSubtotals.annualMaintenance.toLocaleString()}/yr</span>
                        </div>
                      )}
                      ...
                      {pricingSubtotals.monthlyRecurring > 0 && (
                        <div className="flex justify-between text-muted-foreground font-semibold">
                          ...
                          <span className="text-foreground">${pricingSubtotals.monthlyRecurring.toLocaleString()}/mo</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-secondary/40 dark:bg-muted/10 border border-border/80 rounded-2xl p-5">
                    ...
                    <span className="text-[9px] text-muted-foreground block mt-1.5 leading-normal">
                      Includes one-off enterprise licenses plus your first month of workspace subscription services.
                    </span>
                  </div>
                    ...
                    <div className="bg-lime/5 border border-lime/30 rounded-2xl p-3.5 text-[11px] text-muted-foreground flex gap-2">
                      ...
                      <div>
                        {selectedProducts.length === 1 && (
                          <span>Add **1 more product** to unlock a **10% bundle discount**!</span>
                        )}
                        {selectedProducts.length === 2 && (
                          <span>Add **1 more product** to step up to a **15% bundle discount**!</span>
                        )}
                        {selectedProducts.length === 3 && (
                          <span>Add **1 more product** to activate a **25% bundle discount** on all tools!</span>
                        )}
                      </div>
                    </div>
                  )}
                ...
                <div className="py-12 text-center">
                  <p className="text-sm text-muted-foreground mb-4">Please select at least one product module to begin configuring your workspace.</p>
                  <Button
                    onClick={() => setSelectedProducts(PRODUCTS.filter(p => p.priceType !== "custom").map(p => p.id))}
                    variant="outline"
        ...
        <section className="max-w-4xl mx-auto mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-muted-foreground">
              Learn how product licensing, subcontractor seat credits, and billing renewals work.
            </p>
          </div>
        ...
        >
          ...
          <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto mb-8">
            Looking for enterprise-wide controls, dedicated sandbox workspaces, custom SSO integrations, or unlimited seat licensing packages?
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button asChild className="py-6 px-8 rounded-xl font-bold text-sm cursor-pointer bg-foreground text-background pricing-btn-primary">
              <a href="mailto:sales@concolabs.com?subject=Enterprise%20Corporate%20Request">
                Talk to Enterprise Sales
              </a>
            </Button>
            <Button variant="outline" asChild className="py-6 px-8 rounded-xl font-bold text-sm cursor-pointer pricing-btn-outline">
              <a href="https://calendar.app.google/mCq7zBhXrDnEAJvB7" target="_blank" rel="noopener noreferrer">
