    ...
    <main className="min-h-screen bg-[#FAFAF8] dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 antialiased selection:bg-[#ecf000]/30 selection:text-black">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden bg-zinc-50 dark:bg-zinc-950 pt-16">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[-10%] left-[20%] w-[800px] h-[800px] bg-gradient-to-br from-[#ecf000]/20 via-[#ecf000]/10 to-transparent rounded-full blur-[130px] mix-blend-multiply dark:mix-blend-screen opacity-70 animate-pulse" style={{ animationDuration: '9s' }} />
        ...
        >
          <div className="px-6 pt-32 pb-20 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-8">
              ...
              >
                ...
                >
                  ...
                  <br />
                  <span className="text-[#ecf000] dark:text-[#ecf000] font-bold">No 3D model required.</span>
                </motion.p>
            ...
            >
              <div className="relative bg-white/70 dark:bg-zinc-900/70 backdrop-blur-2xl border border-white dark:border-zinc-800 rounded-[2rem] p-8 shadow-2xl shadow-[#ecf000]/5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4">
            ...
            <div className="lg:col-span-2 bg-zinc-900/40 border border-zinc-900 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row justify-between gap-8 overflow-hidden relative group shadow-xl">
              <div className="flex-1 flex flex-col justify-between space-y-6">
                <div className="space-y-4">
                  <span className="text-[9px] font-bold text-[#ecf000] uppercase tracking-widest block">AI Vision Engine</span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-widest text-[#ecf000]">Live Analysis Active</span>
                </div>
              </div>
              ...
              <div className="flex-1 bg-zinc-950/60 border border-zinc-900 rounded-2xl p-6 min-h-[190px] relative overflow-hidden flex flex-col justify-center shadow-inner">
                ...
                <div className="absolute top-[32px] right-[24px] z-10 bg-zinc-900 border border-zinc-800 px-3 py-1.5 rounded-xl flex items-center gap-2 shadow-lg">
                  <div className="text-left leading-none">
                    ...
                    <span className="text-[6px] text-[#ecf000] font-black uppercase tracking-wider">Generated</span>
                  </div>
                </div>
            ...
            <div className="bg-[#12130e] text-white border border-[#ecf000]/15 rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:border-[#ecf000]/30 transition-all duration-300 shadow-md">
              <div className="space-y-4">
                <span className="text-[9px] font-bold text-[#ecf000] uppercase tracking-widest block">Cost Database Sync</span>
