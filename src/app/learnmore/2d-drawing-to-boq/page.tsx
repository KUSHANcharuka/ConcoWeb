          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 rounded-full text-xs font-semibold bg-zinc-200/50 dark:bg-zinc-800 border border-zinc-350 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400">
                Active Regions: Middle East, Sri Lanka, Australia
              </span>
            </div>
            ...
            <p className="text-xl sm:text-2xl text-zinc-500 font-medium leading-normal">
              BOQ from flat drawings — no 3D model needed
            </p>

            <p className="text-base sm:text-lg text-zinc-650 dark:text-zinc-400 leading-relaxed max-w-xl">
              Reads a 2D PDF structural drawing, identifies building elements using computer vision, and produces a priced BOQ. The only BOQ automation tool that operates from flat drawings alone.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50">
              BOQ from drawings that never made it to 3D
            </h2>
          ...
          <div className="lg:col-span-7 text-zinc-650 dark:text-zinc-450 text-base sm:text-lg leading-relaxed space-y-6">
            <p>Many construction projects never create 3D models, leaving quantity surveyors to manually extract measurements from 2D PDF drawings.</p><p>2D Drawing to BOQ uses computer vision to read flat drawings and produce a complete priced BOQ without any 3D model required.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Computer Vision Detection</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">No 3D Model Required</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Priced BOQ Output</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#F4F2F0] dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50 leading-tight">
            BOQs from 2D drawings. No 3D model required.
          </h2>
          <p className="text-zinc-500 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            See how 2D Drawing to BOQ reads flat drawings automatically.
          </p>
