...
// ─────────────────────────────────────────────────────────────────
// FORMAT-SPECIFIC SLOT VALUES — Quanto for ACC
// ─────────────────────────────────────────────────────────────────
const FORMAT = {
  pageTitle: "Quanto for ACC | BOQ from Autodesk Construction Cloud | Concolabs",
  metaDescription:
    "Quanto connects to Autodesk Construction Cloud and generates a priced BOQ. Reprices automatically as the design changes. No export step.",
  h1: "Quanto for ACC",
  subheading: "BOQ from ACC. Repriced instantly as the design changes.",
  heroBody:
    "Your UK and Australian clients work in Autodesk Construction Cloud. Quanto generates a BOQ natively from the live cloud model and reprices it automatically when the design changes. No export, no Excel, no re-entry.",
  regionBadges: ["UK", "Australia"],
  statusBadge: "Scaling" as "Scaling" | "Custom / R&D",
  beforeLabel: "Manual ACC + Excel",
  beforeItems: [
    "Model changes in ACC, then someone exports to Excel and remeasures",
    "Repricing done manually — days per revision",
    "Client sees cost impact days after the design decision",
    "Expert QS time consumed by re-export and re-entry, not advice",
  ],
  step1Title: "ACC Connection",
  step1Body:
    "Quanto connects to your Autodesk Construction Cloud project and reads the live model directly. No export step. When the design changes, the BOQ reprices automatically.",
  price: "$1,200",
  priceNote:
    "Cloud connection per firm. Includes automatic repricing when the design changes.",
  quickFactsBestFor: "QS and Cost Consultancies",
  faqQ5: "What happens when the ACC model is updated?",
  faqA5:
    "Quanto detects the change and reprices the BOQ automatically. No re-export and no manual recalculation.",
  ctaBody:
    "See how Quanto keeps your BOQ current in real time, connected directly to your Autodesk Construction Cloud project.",
  relatedQuantoLinks: [
...
// MAIN PAGE
// ─────────────────────────────────────────────────────────────────
export default function QuantoAccPage() {
                ...
                <div className="w-full border-t border-zinc-200/50 dark:border-zinc-800/50 pt-5">
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="relative flex bg-zinc-100/80 dark:bg-zinc-950/80 p-1 rounded-xl border border-zinc-200/50 dark:border-zinc-850/50">
                      ...
                      <motion.div
                        layoutId="quanto-acc-toggle-pill"
