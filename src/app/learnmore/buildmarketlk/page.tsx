          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 rounded-full text-xs font-semibold bg-zinc-200/50 dark:bg-zinc-800 border border-zinc-350 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400">
                Active Regions: Sri Lanka, Global Licensing
              </span>
            </div>
            ...
            <p className="text-xl sm:text-2xl text-zinc-500 font-medium leading-normal">
              Construction marketplace for suppliers and subcontractors
            </p>

            <p className="text-base sm:text-lg text-zinc-650 dark:text-zinc-400 leading-relaxed max-w-xl">
              Searchable marketplace of material suppliers, builders, and subcontractors. Displays average construction prices so you can benchmark supplier quotes without calling around.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50">
              The supplier discovery bottleneck
            </h2>
          ...
          <div className="lg:col-span-7 text-zinc-650 dark:text-zinc-450 text-base sm:text-lg leading-relaxed space-y-6">
            <p>Finding reliable suppliers and benchmarking prices requires calling multiple vendors and comparing quotes manually.</p><p>BuildMarketlk centralises supplier discovery and displays average market prices, so you can benchmark quotes without calling around.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Searchable Supplier Database</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Average Price Benchmarking</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Multi-Category Listings</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#F4F2F0] dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50 leading-tight">
            Find suppliers and benchmark prices instantly.
          </h2>
          <p className="text-zinc-500 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            See how BuildMarketlk centralises construction procurement.
          </p>
