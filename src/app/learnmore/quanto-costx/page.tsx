...
// ─────────────────────────────────────────────────────────────────
// FORMAT-SPECIFIC SLOT VALUES — Quanto for CostX
// ─────────────────────────────────────────────────────────────────
const FORMAT = {
  pageTitle: "Quanto for CostX | BOQ from CostX Workbooks | Concolabs",
  metaDescription:
    "Quanto reads your CostX workbook and adds AI rate prediction on top. Priced BOQ without the manual rate lookup.",
  h1: "Quanto for CostX",
  subheading: "Your CostX quantities. Priced by AI, not by hand.",
  heroBody:
    "CostX gives you measured quantities. But pricing is still applied manually against historical rate data, the same lookup every project. Quanto takes your CostX workbook and adds AI rate prediction on top, so pricing stops being a manual step.",
  regionBadges: ["UK", "Australia", "UAE"],
  statusBadge: "Scaling" as "Scaling" | "Custom / R&D",
  beforeLabel: "CostX + Manual Pricing",
  beforeItems: [
    "CostX produces measured quantities — pricing still applied manually",
    "Rate lookup done against historical data, the same process every project",
    "Rates can be inconsistent across team members",
    "Expert QS time consumed by rate entry, not advice",
  ],
  step1Title: "CostX Import",
  step1Body:
    "Upload your CostX workbook. Quanto reads the measured items directly and carries them into the rate prediction engine.",
  // ⚠ PLACEHOLDER — confirm real price with Ishini before publishing
  price: "$900",
  priceNote:
    "Workbook import and rate prediction module. [Confirm pricing before publishing]",
  quickFactsBestFor: "QS and Cost Consultancies",
  faqQ5: "Does this replace CostX, or work alongside it?",
  faqA5:
    "Alongside it. Quanto takes the quantities CostX has already measured and adds AI rate prediction on top. Pricing stops being a manual lookup.",
  ctaBody:
    "See how Quanto takes your CostX quantities and adds AI rate prediction, so pricing is done before your team sits down.",
  relatedQuantoLinks: [
...
// MAIN PAGE
// ─────────────────────────────────────────────────────────────────
export default function QuantoCostXPage() {
          ...
          {heroVideoActive && (
            ...
            >
              ...
              >
                <video
                  ref={videoRef}
                  src="/videos/Quanto%20for%20CostX/Quanto_%20Revit%20to%20BOQ%20Automation_1080p%20(1)-h264.mp4"
                  autoPlay
                  loop
                  muted
                  playsInline
                ...
                <div className="w-full border-t border-zinc-200/50 dark:border-zinc-800/50 pt-5">
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="relative flex bg-zinc-100/80 dark:bg-zinc-950/80 p-1 rounded-xl border border-zinc-200/50 dark:border-zinc-850/50">
                      ...
                      <motion.div
                        layoutId="quanto-costx-toggle-pill"
