        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-xl sm:text-2xl text-zinc-500 font-medium leading-normal">
              Cloud-native BOQ from Autodesk Construction Cloud
            </p>

            <p className="text-base sm:text-lg text-zinc-650 dark:text-zinc-400 leading-relaxed max-w-xl">
              Same BOQ automation as the Revit plugin, built natively for Autodesk Construction Cloud — no export step. Automatically reprices when the design proposal changes.
            </p>
      ...
      <section className="bg-white dark:bg-zinc-900 border-y border-zinc-200 dark:border-zinc-800 py-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-zinc-650 dark:text-zinc-450 text-base sm:text-lg leading-relaxed space-y-6">
            <p>Teams using Autodesk Construction Cloud still export data to create BOQs manually, breaking the seamless cloud workflow.</p><p>Autodesk CC to BOQ works entirely within the ACC ecosystem, generating and updating BOQs automatically as designs evolve.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Native ACC Integration</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Auto-repricing on Changes</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Cloud-native Workflow</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#F4F2F0] dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50 leading-tight">
            BOQs that stay in sync with your cloud models.
          </h2>
          <p className="text-zinc-500 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            See how Autodesk CC to BOQ works within your ACC workflow.
          </p>
