        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-xl sm:text-2xl text-zinc-500 font-medium leading-normal">
              Bridge the gap between site and back office
            </p>

            <p className="text-base sm:text-lg text-zinc-650 dark:text-zinc-400 leading-relaxed max-w-xl">
              Email instructions automatically converted into ERP job cards. Site app data syncs directly to the ERP, eliminating the lag between field activity and financial records.
            </p>
      ...
      <section className="bg-white dark:bg-zinc-900 border-y border-zinc-200 dark:border-zinc-800 py-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-zinc-650 dark:text-zinc-450 text-base sm:text-lg leading-relaxed space-y-6">
            <p>Construction companies struggle with the lag between field activities and financial records — site data must be manually entered into ERP systems.</p><p>ERP Automations bridges this gap by syncing site data directly to your ERP, converting email instructions into job cards automatically.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Email-to-Job-Card Conversion</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">ERP Sync</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Automated Workflows</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#F4F2F0] dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-zinc-500 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            See how ERP Automations syncs site data to your ERP.
          </p>
