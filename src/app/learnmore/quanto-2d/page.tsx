...
// ─────────────────────────────────────────────────────────────────
// FORMAT-SPECIFIC SLOT VALUES — Quanto for 2D
// ─────────────────────────────────────────────────────────────────
const FORMAT = {
  pageTitle: "Quanto for 2D | BOQ from Flat Drawings | Concolabs",
  metaDescription:
    "Quanto reads a 2D PDF or DXF drawing and returns a priced BOQ. No 3D model needed. Computer vision identifies elements from flat drawings.",
  h1: "Quanto for 2D Drawings",
  subheading: "BOQ from flat drawings. No 3D model needed.",
  heroBody:
    "Many construction projects never create 3D models. Quanto reads a 2D PDF or DXF drawing using computer vision, identifies building elements, and produces a priced BOQ. No 3D model required. DXF gives the most reliable read, PDF is supported best effort.",
  regionBadges: ["Middle East", "Sri Lanka", "Australia"],
  statusBadge: "Custom / R&D" as "Scaling" | "Custom / R&D",
  beforeLabel: "Manual Take-off from Flat Drawings",
  beforeItems: [
    "No 3D model exists — quantities taken off flat drawings by hand",
    "The slowest starting point of the four input formats",
    "Most prone to measuring errors on complex drawings",
    "Expert QS time consumed entirely by measurement, not advice",
  ],
  step1Title: "Drawing Upload",
  step1Body:
    "Upload your 2D PDF or DXF drawing. Computer vision identifies building elements from the flat drawing. DXF gives the most reliable read, PDF is supported best effort.",
  // ⚠ PLACEHOLDER — confirm real price with Ishini before publishing
  price: "$900",
  priceNote:
    "Computer vision drawing read and rate prediction module. [Confirm pricing before publishing]",
  quickFactsBestFor: "Contractors and QS Firms",
  faqQ5: "What if the drawing quality is poor or it is a hand sketch?",
  faqA5:
    "Clean DXF or DWG files give the most accurate read. Scanned or hand-drawn input is supported best effort. Lower-confidence elements are flagged for review rather than guessed at.",
  ctaBody:
    "See how Quanto reads flat drawings and returns a priced BOQ, no 3D model required.",
  relatedQuantoLinks: [
    { href: "/learnmore/quanto-revit", label: "Quanto for Revit" },
    { href: "/learnmore/quanto-acc", label: "Quanto for ACC" },
    { href: "/learnmore/quanto-costx", label: "Quanto for CostX" },
  ],
  // 2D page only: show the Auto Conversion 2D to 3D card in Related Products
  showAutoConversionCard: true,
};
...
// MAIN PAGE
// ─────────────────────────────────────────────────────────────────
export default function Quanto2DPage() {
                ...
                <div className="w-full border-t border-zinc-200/50 dark:border-zinc-800/50 pt-5">
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="relative flex bg-zinc-100/80 dark:bg-zinc-950/80 p-1 rounded-xl border border-zinc-200/50 dark:border-zinc-850/50">
                      ...
                      <motion.div
                        layoutId="quanto-2d-toggle-pill"
            ...
            >
              <div>
                ...
                <ul className="space-y-5 text-sm">
                  ...
                  {/* 2D page only: Auto Conversion card */}
                  {FORMAT.showAutoConversionCard && (
                    <li>
                      <Link href="/learnmore/auto-conversion-2d-to-3d" className="group flex items-start gap-3 p-3 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors border border-zinc-100 dark:border-zinc-800 rounded-xl bg-zinc-50/50 dark:bg-zinc-800/20">
                        <div className="w-8 h-8 rounded-lg bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center shrink-0">
                          <Box className="w-4 h-4 text-zinc-600 dark:text-zinc-400" />
                        </div>
                        <div>
                          <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 block mb-0.5">Also need a 3D model, not just a BOQ?</span>
                          <span className="font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition-colors block">Auto Conversion 2D to 3D</span>
                          <span className="text-xs text-zinc-400">Reads the same drawing and builds a 3D BIM model, not just a BOQ.</span>
                        </div>
                      </Link>
                    </li>
                  )}
