...
export default function PlanningLawChatbotPage() {
  ...
  // Step 1 Screenshot (visible during Step 1 text)
  const screenshot1Opacity = useTransform(showcaseScrollProgress, [0.32, 0.38, 0.44, 0.50], [0, 1, 1, 0]);
  const screenshot1Y = useTransform(showcaseScrollProgress, [0.32, 0.38, 0.44, 0.50], [60, 0, 0, -60]);
  const screenshot1Scale = useTransform(showcaseScrollProgress, [0.32, 0.38, 0.44, 0.50], [0.95, 1, 1, 1.05]);

  // Step 2 Screenshot (visible during Step 2 text)
  const screenshot2Opacity = useTransform(showcaseScrollProgress, [0.48, 0.54, 0.60, 0.66], [0, 1, 1, 0]);
  const screenshot2Y = useTransform(showcaseScrollProgress, [0.48, 0.54, 0.60, 0.66], [60, 0, 0, -60]);
  const screenshot2Scale = useTransform(showcaseScrollProgress, [0.48, 0.54, 0.60, 0.66], [0.95, 1, 1, 1.05]);

  // Step 3 Screenshot (visible during Step 3 text)
  const screenshot3Opacity = useTransform(showcaseScrollProgress, [0.64, 0.70, 0.76, 0.82], [0, 1, 1, 0]);
  const screenshot3Y = useTransform(showcaseScrollProgress, [0.64, 0.70, 0.76, 0.82], [60, 0, 0, -60]);
  const screenshot3Scale = useTransform(showcaseScrollProgress, [0.64, 0.70, 0.76, 0.82], [0.95, 1, 1, 1.05]);

  // Step 4 Screenshot (visible during Step 4 text)
  const screenshot4Opacity = useTransform(showcaseScrollProgress, [0.80, 0.86, 0.96, 1.0], [0, 1, 1, 1]);
  const screenshot4Y = useTransform(showcaseScrollProgress, [0.80, 0.86, 0.96, 1.0], [60, 0, 0, 0]);
  const screenshot4Scale = useTransform(showcaseScrollProgress, [0.80, 0.86, 0.96, 1.0], [0.95, 1, 1, 1]);
      ...
      >
        ...
        >
          ...
          >
            <video
              ref={videoRef}
              src="/videos/planning-law-chatbot/planning-law-chatbot-intro.mp4"
              loop
          ...
          <div className="px-6 pt-32 pb-20 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-zinc-950 dark:text-white leading-[1.05] uppercase product-title-sweep">
            ...
            <div className="relative lg:col-span-7 h-[480px]">
              ...
              >
                <div className="w-full bg-zinc-900/90 rounded-2xl border border-white/10 p-2 shadow-2xl shadow-zinc-400/20 dark:shadow-black/80 backdrop-blur-md overflow-hidden">
                  ...
                  <img
                    src="/images/Planning%20Law%20Chatbot/1.%20Input.png"
              ...
              >
                <div className="w-full bg-zinc-900/90 rounded-2xl border border-white/10 p-2 shadow-2xl shadow-zinc-400/20 dark:shadow-black/80 backdrop-blur-md overflow-hidden">
                  ...
                  <img
                    src="/images/Planning%20Law%20Chatbot/2.%20Planning%20Law%20Chatbot.png"
                    alt="Step 2 — Analysis"
                    className="w-full h-auto rounded-lg object-cover"
                  />
                </div>
              ...
              >
                <div className="w-full bg-zinc-900/90 rounded-2xl border border-white/10 p-2 shadow-2xl shadow-zinc-400/20 dark:shadow-black/80 backdrop-blur-md overflow-hidden">
                  ...
                  <img
                    src="/images/Planning%20Law%20Chatbot/3.%20Constraints%20Feed.png"
                    alt="Step 3 — Envelope"
                    className="w-full h-auto rounded-lg object-cover"
                  />
                </div>
              ...
              >
                <div className="w-full bg-zinc-900/90 rounded-2xl border border-white/10 p-2 shadow-2xl shadow-zinc-400/20 dark:shadow-black/80 backdrop-blur-md overflow-hidden">
                  ...
                  <img
                    src="/images/Planning%20Law%20Chatbot/4.%20Cost%20Estimate.png"
