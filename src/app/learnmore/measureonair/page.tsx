        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-xl sm:text-2xl text-zinc-500 font-medium leading-normal">
              From site measurement to payment certificate digitally
            </p>

            <p className="text-base sm:text-lg text-zinc-650 dark:text-zinc-400 leading-relaxed max-w-xl">
              Record measurements directly against the digital drawing on site — no printed plans. Payment applications and interim certificates generate automatically from the recorded measurements.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50">
              Digital measurement from site to certificate
            </h2>
          ...
          <div className="lg:col-span-7 text-zinc-650 dark:text-zinc-450 text-base sm:text-lg leading-relaxed space-y-6">
            <p>Site measurements are still taken on printed plans, then manually transferred to digital formats for payment applications.</p><p>MeasureonAir lets site teams record measurements directly against digital drawings, generating payment certificates automatically.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Digital Drawing Annotation</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Auto Payment Certificate Generation</h3>
            </div>
            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-2 shadow-xs">
              <h3 className="font-bold text-base text-zinc-950 dark:text-zinc-50">Offline-First Mobile</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#F4F2F0] dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-zinc-500 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            See how MeasureonAir streamlines the measurement workflow.
          </p>
